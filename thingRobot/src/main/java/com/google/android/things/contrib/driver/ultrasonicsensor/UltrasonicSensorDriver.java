...
public final class UltrasonicSensorDriver implements AutoCloseable {
    ...
    private GpioCallback mEchoCallback = new GpioCallback() {
        ...
        public void onGpioError(Gpio gpio, int error) {
            Timber.e("Error %d with %s", error, gpio.getName());
        }
    };
     ...
     * Set the trigger pin
     *
     * @param service    {@link PeripheralManager}.
     * @param triggerPin Name of the trigger pin.
     * @throws IOException If pin initialization fails.
     */
    private void setTriggerPin(PeripheralManager service, String triggerPin) throws IOException {
     ...
     * @throws IOException If pin initialization fails.
     */
    private void setEchoPin(PeripheralManager service, String echoPin) throws IOException {
